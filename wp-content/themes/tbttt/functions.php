...
function sensible_setup() {
	...
	register_nav_menus( array(
		...
		'mobile' => esc_html__( 'Mobile', 'sensible' ),
	) );
 ...
 */
function load_fonts() {
            wp_register_style('googleFonts', 'https://fonts.googleapis.com/css?family=Lato|Open+Sans:100,300,400,400italic,500,700', array(), '1.0');
...
/* Ajax Login for Members Login */
function ajax_login_init(){

    wp_register_script('ajax-login-script', get_template_directory_uri() . '/assets/js/ajax-login.js', array('jquery') ); 
